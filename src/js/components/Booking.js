...
class Booking {
  ...
  getData() {
    ...
    Promise.all([
      ...
      .then(function (allResponse) {
        ...
        const eventsCurrent = allResponse[1];
  ...
  updateDOM() {
    ...
    const activeTable = thisBooking.dom.floorPlan.querySelector('.' + classNames.booking.tableSelected);
    if (activeTable) {
  ...
  initTables(event) {
    ...
    /* if clicking on already selected table - deselect it */
